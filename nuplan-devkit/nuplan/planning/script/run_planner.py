...
from nuplan.planning.simulation.planner.project2.my_planner_long import MyPlanner01
...
planner = MyPlanner(horizon_seconds=8.0, sampling_time=0.25, max_velocity=25)
